import { PessoaBeneficio, Retorno } from "./fInterfaces";

// Adiciona um ou mais registros de PessoaBeneficio
export function createPessoaBeneficio(
	pessoaBeneficios: PessoaBeneficio[] | PessoaBeneficio,
...
function pessoaBeneficioAsList(pb: PessoaBeneficio): (string | number)[] {
	return [
		pb.cpf,
		pb.id_beneficio,
...
export function recoverPessoaBeneficio(
	cpf_pessoa: string,
	database = getDataBase()
): PessoaBeneficio[] {
	const lista = tableToObject<PessoaBeneficio>("fPessoaBeneficio", database);
	return lista.filter((pb) => pb.cpf === cpf_pessoa);
}

// Atualiza todos os registros de PessoaBeneficio para um cpf_pessoa
export function updatePessoaBeneficio(
	cpf_pessoa: string,
	novos: PessoaBeneficio[],
	database = getDataBase()
): Retorno {
...
export function deletePessoaBeneficio(
	cpf_pessoa: string,
	database = getDataBase()
): Retorno {
	const sheet = getSheet("fPessoaBeneficio", database);
